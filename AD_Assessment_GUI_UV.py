...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.afm_img_result = customtkinter.CTkLabel(master=self.tabview.tab("AFM"), width=IMAGE_WIDTH,
                                                     ...
                                                     font=customtkinter.CTkFont(size=16, weight="bold"))
        self.afm_img_result.grid(row=1, column=0, padx=20, pady=36, sticky="nsew")
    ...
    def analyze_event(self):
        ...
        self.qc_label_afm = customtkinter.CTkLabel(self.button_frame_afm,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.qc_label_afm.grid(row=1, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.age_label_afm = customtkinter.CTkLabel(self.button_frame_afm,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.age_label_afm.grid(row=2, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.uv_label_afm = customtkinter.CTkLabel(self.button_frame_afm,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.uv_label_afm.grid(row=3, column=0, padx=0, pady=(0, 15), sticky="new", columnspan=3)
        self.previous_btn_afm = customtkinter.CTkButton(self.button_frame_afm, command=self.previous_event,
                                                        text="Previous")
        self.previous_btn_afm.grid(row=4, column=0, padx=10, sticky="new")
        self.image_label_afm = customtkinter.CTkLabel(self.button_frame_afm, text="1 / 1")
        self.image_label_afm.grid(row=4, column=1, padx=10, pady=(0, 5), sticky="new")
        self.next_btn_afm = customtkinter.CTkButton(self.button_frame_afm, command=self.next_event, text="Next")
        self.next_btn_afm.grid(row=4, column=2, padx=10, sticky="new")
        ...
        self.qc_label_cno = customtkinter.CTkLabel(self.button_frame_cno,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.qc_label_cno.grid(row=1, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.age_label_cno = customtkinter.CTkLabel(self.button_frame_cno,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.age_label_cno.grid(row=2, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.uv_label_cno = customtkinter.CTkLabel(self.button_frame_cno,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.uv_label_cno.grid(row=3, column=0, padx=0, pady=(0, 15), sticky="new", columnspan=3)
        self.previous_btn_cno = customtkinter.CTkButton(self.button_frame_cno, command=self.previous_event,
                                                        text="Previous")
        self.previous_btn_cno.grid(row=4, column=0, padx=10, sticky="new")
        self.image_label_cno = customtkinter.CTkLabel(self.button_frame_cno, text="1 / 1")
        self.image_label_cno.grid(row=4, column=1, padx=10, pady=(0, 5), sticky="new")
        self.next_btn_cno = customtkinter.CTkButton(self.button_frame_cno, command=self.next_event, text="Next")
        self.next_btn_cno.grid(row=4, column=2, padx=10, sticky="new")
        ...
        self.qc_label_kde = customtkinter.CTkLabel(self.button_frame_kde,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.qc_label_kde.grid(row=1, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.age_label_kde = customtkinter.CTkLabel(self.button_frame_kde,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.age_label_kde.grid(row=2, column=0, padx=0, pady=(0, 5), sticky="new", columnspan=3)
        self.uv_label_kde = customtkinter.CTkLabel(self.button_frame_kde,
                                                text=" ",
                                                font=customtkinter.CTkFont(size=16, weight="bold"))
        self.uv_label_kde.grid(row=3, column=0, padx=0, pady=(0, 15), sticky="new", columnspan=3)
        self.previous_btn_kde = customtkinter.CTkButton(self.button_frame_kde, command=self.previous_event,
                                                        text="Previous")
        self.previous_btn_kde.grid(row=4, column=0, padx=10, sticky="new")
        self.image_label_kde = customtkinter.CTkLabel(self.button_frame_kde, text="1 / 1")
        self.image_label_kde.grid(row=4, column=1, padx=10, pady=(0, 5), sticky="new")
        self.next_btn_kde = customtkinter.CTkButton(self.button_frame_kde, command=self.next_event, text="Next")
        self.next_btn_kde.grid(row=4, column=2, padx=10, sticky="new")
    ...
    def show_image(self, image_view):
        ...
        self.qc_result = self.df['QC'][image_view]
        self.qc_confidence = self.df['QC_Conf'][image_view]
        self.age_result = self.df['Age'][image_view]
        self.age_confidence = self.df['Age_Conf'][image_view]
        self.uv_result = self.df['UV'][image_view]
        self.uv_confidence = self.df['UV_Conf'][image_view]
        ...
        # Determine frame color based on QC result
        qc_color = "green" if self.qc_result == "Passed" else "red"
        ...
        self.result_label_afm.configure(
            text=f"CNO: {self.cno_count + 1} | ECTI: {self.kde_density} | Area: {self.area_cover}%",
            text_color=color)
        self.qc_label_afm.configure(
            text=f"QC Prediction: {self.qc_result} | Confidence: {self.qc_confidence:.2f}",
            text_color=qc_color)
        self.age_label_afm.configure(
            text=f"Age Prediction: {self.age_result} | Confidence: {self.age_confidence:.2f}")
        self.uv_label_afm.configure(
            text=f"UV Prediction: {self.uv_result} | Confidence: {self.uv_confidence:.2f}")
        self.image_label_afm.configure(text=f"{image_view + 1} / {self.image_num}")
        ...
        self.result_label_cno.configure(
            text=f"CNO: {self.cno_count + 1} | ECTI: {self.kde_density} | Area: {self.area_cover}%",
            text_color=color)
        self.qc_label_cno.configure(
            text=f"QC Prediction: {self.qc_result} | Confidence: {self.qc_confidence:.2f}",
            text_color=qc_color)
        self.age_label_cno.configure(
            text=f"Age Prediction: {self.age_result} | Confidence: {self.age_confidence:.2f}")
        self.uv_label_cno.configure(
            text=f"UV Prediction: {self.uv_result} | Confidence: {self.uv_confidence:.2f}")
        self.image_label_cno.configure(text=f"{image_view + 1} / {self.image_num}")
        ...
        self.result_label_kde.configure(
            text=f"CNO: {self.cno_count + 1} | ECTI: {self.kde_density} | Area: {self.area_cover}%",
            text_color=color)
        self.qc_label_kde.configure(
            text=f"QC Prediction: {self.qc_result} | Confidence: {self.qc_confidence:.2f}",
            text_color=qc_color)
        self.age_label_kde.configure(
            text=f"Age Prediction: {self.age_result} | Confidence: {self.age_confidence:.2f}")
        self.uv_label_kde.configure(
            text=f"UV Prediction: {self.uv_result} | Confidence: {self.uv_confidence:.2f}")
        self.image_label_kde.configure(text=f"{image_view + 1} / {self.image_num}")
        ...
        print(f"QC Result: {self.qc_result}")
        print(f"Confidence: {self.qc_confidence:.2f}")
        print(f"Age Result: {self.age_result}")
        print(f"Confidence: {self.age_confidence:.2f}")
        print(f"UV Result: {self.uv_result}")
        print(f"Confidence: {self.uv_confidence:.2f}")
