...
class App(customtkinter.CTk):
    ...
    def show_image(self, image_view):
        ...
        self.confidence = self.df['QC_Conf'][image_view]
        ...
        self.qc_label_afm.configure(
            text=f"QC Prediction: {self.qc_result} | Confidence: {self.confidence:.2f}",
            text_color=qc_color)
